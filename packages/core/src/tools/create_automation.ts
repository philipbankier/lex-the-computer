...
import { scheduleAutomation } from '../lib/queue.js';

export const createAutomationTool: ToolDefinition<{ name: string; instruction: string; schedule: string; delivery_method?: string; model?: string }> = {
  name: 'create_automation',
  description: 'Create a scheduled automation with name, instruction, and cron schedule',
  parameters: {
    type: 'object',
    properties: {
      name: { type: 'string' },
